...
cd dist
infer.exe --input_images_dir D:/data/images2 --det_model_path D:/data/ch_ppocr_server_v2.0_det_infer_cpu.ms --rec_model_path D:/data/ch_ppocr_server_v2.0_rec_infer_cpu.ms --rec_char_dict_path D:/data/ppocr_keys_v1.txt --res_save_dir det_rec
cd ..