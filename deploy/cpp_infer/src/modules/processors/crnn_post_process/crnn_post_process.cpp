...
Status CrnnPostProcess::Init(CommandParser *options, const AscendBaseModule::ModuleInitArgs &initArgs) {
...
Status CrnnPostProcess::PostProcessMindXCrnn(uint32_t framesSize, const std::vector<MxBase::Tensor> &inferOutput,
...
Status CrnnPostProcess::PostProcessLiteCrnn(uint32_t framesSize, const std::vector<mindspore::MSTensor> &inferOutput,
                                            std::vector<std::string> *textsInfos) {
