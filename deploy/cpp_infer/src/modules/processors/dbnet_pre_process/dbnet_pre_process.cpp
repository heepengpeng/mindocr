...
Status DbnetPreProcess::Init(CommandParser *options, const AscendBaseModule::ModuleInitArgs &initArgs) {
...
void DbnetPreProcess::NormalizeByChannel(std::vector<cv::Mat> *bgrChannels) {
