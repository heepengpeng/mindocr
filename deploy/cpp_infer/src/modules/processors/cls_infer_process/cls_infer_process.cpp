...
ClsInferProcess::~ClsInferProcess() = default;

Status ClsInferProcess::Init(CommandParser *options, const ModuleInitArgs &initArgs) {
...
Status ClsInferProcess::DeInit() {
  LogInfo << "cls_infer_process [" << instanceId_ << "]: Deinit success.";
  return Status::OK;
}

Status ClsInferProcess::ParseConfig(CommandParser *options, const ModuleInitArgs &initArgs) {
...
Status ClsInferProcess::LiteModelInfer(const std::shared_ptr<CommonData> &data) const {
...
Status ClsInferProcess::MindXModelInfer(const std::shared_ptr<CommonData> &data) const {
...
Status ClsInferProcess::Process(std::shared_ptr<void> commonData) {
