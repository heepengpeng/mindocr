...
Status ClsPostProcess::Init(CommandParser *options, const AscendBaseModule::ModuleInitArgs &initArgs) {
...
Status ClsPostProcess::PostProcessMindXCls(uint32_t framesSize, const std::vector<MxBase::Tensor> &inferOutput,
...
Status ClsPostProcess::PostProcessLiteCls(uint32_t framesSize, const std::vector<mindspore::MSTensor> &inferOutput,
                                          const std::vector<cv::Mat> &imgMatVec, std::vector<std::string> *inferRes) {
