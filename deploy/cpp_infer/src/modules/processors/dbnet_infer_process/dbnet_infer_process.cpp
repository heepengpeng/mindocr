...
DbnetInferProcess::~DbnetInferProcess() = default;

Status DbnetInferProcess::Init(CommandParser *options, const AscendBaseModule::ModuleInitArgs &initArgs) {
...
Status DbnetInferProcess::DeInit() {
  LogInfo << "dbnet_infer_process [" << instanceId_ << "]: Deinit success.";
  return Status::OK;
}

Status DbnetInferProcess::ParseConfig(CommandParser *options, const ModuleInitArgs &initArgs) {
...
Status DbnetInferProcess::Process(std::shared_ptr<void> commonData) {
...
Status DbnetInferProcess::LiteModelInfer(std::shared_ptr<CommonData> data) {
...
Status DbnetInferProcess::MindXModelInfer(std::shared_ptr<CommonData> data) {
